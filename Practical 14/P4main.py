...
def run():
    ...
    # this line of code runs the model by initialising the dictionaries and passing it straight through into the model
    time_array, finished_dicts = ocean_model(initialise_dicts(), 3000, 0.5)
